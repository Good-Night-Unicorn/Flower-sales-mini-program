      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商铺编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangpubianhao" class="input" type="text" placeholder="商铺编号">
			   </div>
			 </div> -->
			<el-form-item label="商铺编号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangpubianhao" autocomplete="off" placeholder="商铺编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="商铺名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangpumingcheng" autocomplete="off" placeholder="商铺名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<el-form-item label="商铺地址" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangpudizhi" autocomplete="off" placeholder="商铺地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
