<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="shangpubianhao">
          <el-input v-model="ruleForm.shangpubianhao" 
              placeholder="商户名称" clearable  :readonly="ro.shangpubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="shangpubianhao">
              <el-input v-model="ruleForm.shangpubianhao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm67m8n/upload');
        } else {
